...
const fields = "id, workspace_id, tutor_id, pet_id, veterinario_id, tipo, tipo_evento, titulo, descricao, data_hora, status, created_at, created_by, created_by_name, updated_at, updated_by, updated_by_name, deleted_at, deleted_by, deleted_by_name";
